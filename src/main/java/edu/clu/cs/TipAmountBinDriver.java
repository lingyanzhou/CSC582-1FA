...
public class TipAmountBinDriver {
	...
	public static void execute(String outPathName, String inPathName)
		...
		Job job = Job.getInstance(conf, "Group3 TipAmountBin");
		job.setJarByClass(TipAmountBinDriver.class);
		...
		ChainMapper.addMapper(job, TipAmountBinMapper.class,
